...
{#if hasSelection}
	<div class="absolute top-2 right-2 z-50 bg-white/95 backdrop-blur-sm border border-stone-200/50 shadow-lg rounded-lg p-3 w-[200px] overflow-hidden">
			...
			{#if isSingleSelection && hasShapes}
				<div class="flex items-center gap-2 min-w-0">
					...
					<input
						...
						class="flex-1 min-w-0 h-1 bg-stone-200 rounded-lg appearance-none cursor-pointer accent-stone-600"
						id="line-width"
					/>
					<input
						type="number"
						...
						max="20"
						step="0.5"
						class="w-12 px-1.5 py-1 text-xs border border-stone-200 rounded bg-stone-50 focus:outline-none focus:ring-1 focus:ring-stone-400 shrink-0"
