...
import { editorApi, rectangles, ellipses, lines, arrows, diamonds, paths, images, zoom, viewportOffset, type Rectangle, type Ellipse, type Line, type Arrow, type Diamond, type Path, type Image } from '$lib/stores/editor';
