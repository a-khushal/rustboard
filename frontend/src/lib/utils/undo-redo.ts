...
import { editorApi, rectangles, ellipses, lines, arrows, diamonds, texts, paths, groups, type Rectangle, type Ellipse, type Line, type Arrow, type Diamond, type Text, type Path, type Group } from '$lib/stores/editor';
