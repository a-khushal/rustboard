...
import { editorApi, rectangles, ellipses, lines, arrows, diamonds, texts, groups, type Rectangle, type Ellipse, type Line, type Arrow, type Diamond, type Text, type Group } from '$lib/stores/editor';
